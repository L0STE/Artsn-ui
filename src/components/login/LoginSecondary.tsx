            ...
            <div className={className}>
                <div className="w-full">
                    <div className='flex flex-col gap-6'>
                        <Card className='bg-transparent flex flex-col text-secondary border-none w-full z-[301]'>
                            <CardHeader className='bg-transparent rounded-t-xl'>
                                <CardTitle className='font-bold self-center'>
                                Please login to continue
                                </CardTitle>
                            </CardHeader>

                            <CardContent className='bg-transparent flex flex-col gap-2'>
                                <Button 
                            ...
                            <CardFooter className='bg-transparent flex flex-col gap-2 rounded-b-xl text-xs'>
