...
// const ProductCard = ({ account, listing, image, currentFilter }: { image: string, account: PublicKey, listing: Listing, currentFilter?: string }) => {
...
//       {!loading && obj?.contains(currentFilter) || !loading && !currentFilter && (
