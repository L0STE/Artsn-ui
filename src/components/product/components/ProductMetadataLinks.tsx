...
export default function MetadataLinks({ mintAddress, associatedId }: MetadataLinksProps) {
    ...
    return (
      <div className="bg-white rounded-3xl p-5 border-gray mb-5 ">
        ...
        <section className="flex md:flex-row flex-col gap-2">
          <button 
            className="border-gray font-normal py-2 text-sm px-4 rounded-full flex items-center gap-2"
            onClick={() => router.push(`https://solscan.io/account/${mintAddress}?cluster=devnet`)}
          >
            <svg
              width="20"
              height="16"
          ...
          <button 
            className="border-gray font-normal py-2 text-sm px-4 rounded-full flex items-center gap-2"
            onClick={() => router.push(`https://solscan.io/account/${associatedId}?cluster=devnet`)}
          >
            <svg
              width="20"
              height="16"
