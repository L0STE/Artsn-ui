  ...
  return (
    <Suspense fallback={<div />}>
      {LoginFeatureProps.isOpen && (
        <nav className="items-left md:blocks absolute left-1/2 top-full z-[150] flex h-screen w-full -translate-x-1/2 flex-col justify-end gap-12 self-center bg-transparent p-6 pb-28 text-sm shadow-xl duration-200 md:static md:left-auto md:top-auto md:h-auto md:w-auto md:transform-none md:rounded-none md:shadow-none">
