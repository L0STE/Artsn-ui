          ...
          <div className="container">
            <div className="header-container">
              <h1 className="display-2">
                <span className="highlight">Digitally Owned</span>
              </h1>
              {/* <TextTransition
                                style={{ color: "#fff" }}
            ...
            <div className="bottom">
              <h2 className="heading-1">Collect & Trade Luxury Goods</h2>
        ...
        <div className="boxed">
          <div className="home__about__illustration">
            ...
            <h1 className="home__about__illustration__primary">
              Luxury Goods
              <br />
              <span className="emphasis">Grow.</span>
            </h1>
            ...
            <div className="home__about__content__col col-1">
              ...
              <div className="home__about__content__col__item item-1">
                ...
                <p className="caption-2">
                  Own a % of Authentic Certified Luxury Good stored in secured
                  volts.
                </p>
              </div>
              ...
              <div className="home__about__content__col__item item-2">
                ...
                <p className="caption-2">
                  In the last 7 years the Luxury Watch Market outperformed the
                  S&P 500 by 117% while Artprice100 index by 800%.
                </p>
              </div>
              ...
              <div className="home__about__content__col__item item-3">
                ...
                <p className="caption-2">
                  Top-Tier Goods are characterized by Limited Supply and High
                  Demand.
                </p>
              </div>
            </div>
